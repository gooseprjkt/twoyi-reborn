...
public class Render2Activity extends Activity implements View.OnTouchListener {
    ...
    private final SurfaceHolder.Callback mSurfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(@NonNull SurfaceHolder holder) {
            ...
            Log.w(TAG, "current fps: " + refreshRate);
            Renderer.init(surface, RomManager.getLoaderPath(getApplicationContext()), xdpi, ydpi, (int) refreshRate);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus) {
            getWindow().getDecorView().setSystemUiVisibility(5894); // Match new version's flags
        }
    ...
    public void onBackPressed() {
        Renderer.sendKeycode(KeyEvent.KEYCODE_BACK);
    }
